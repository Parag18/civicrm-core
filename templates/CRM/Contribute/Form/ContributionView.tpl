...
<div class="action-link">
  <div class="crm-submit-buttons">
    ...
    {assign var='printUrlParams' value="reset=1&id=$id&cid=$contact_id&select=pdf"}
    ...
    {if $contribution_status != 'Refunded'}
      <div class="crm-printButton"><a class="button" href="{crmURL p='civicrm/contribute/invoice' q=$printUrlParams}">
      {ts}Print Invoice{/ts}</a>
      <a class="button" href="{crmURL p='civicrm/contribute/invoice' q=$emailUrlParams}">
